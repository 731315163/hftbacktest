...
use hftbacktest::{backtest::data::POD, depth::MarketDepth};
...
#[repr(C)]
#[derive(rust2go::R2G,Clone, Debug, Decode, Encode)]
...
#[repr(C)]
#[derive(rust2go::R2G,Clone, Copy, Eq, PartialEq, Debug, Decode, Encode)]
pub enum ErrorKind {
...
/// Order status
#[derive(R2G,Clone, Copy, Eq, PartialEq, Debug, Decode, Encode)]
#[repr(u8)]
pub enum Status {
    None = 0,
    New = 1,
