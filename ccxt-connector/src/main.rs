...
async fn main() {
    let mut b = BinanceImpl::new(Value::Json(json!({
        "apiKey": "UQOqOx1f0lcckVRwXfAwR4gmzUjV27xeZO4Ph9xu7dnw6vLaceEOlGWmoYNwULJx",
        "secret": "qFbb1BtYfnltVyA35sHxu7xMrOS0C1byDfPqG82lHj6fOgHgGnsiW1S5XEwdl7zM"
    })));
    Binance::load_markets(&mut b, UNDEFINED, UNDEFINED).await;
    print!("{}","load markets");
